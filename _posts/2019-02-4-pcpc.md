...
**Note B is Book and C is Chapter**
...
## Develop different solutions to the problem exploiting:
- only point-to-point MPI communication routines and OpenMP.
- only collective MPI communication routines and OpenMP.
