...
|Lecture 6 | 18/04| Algoritmi per memoria condivisa + Progettazione di Algoritmi Paralleli| B2: C3.5.1-C3.5.4-C3.5.5 - [counting sort](https://spagnuolocarmine.github.io/news/counting-sort/) |

<!--
|Lab 7      | 30/04| Amazon Web Service Lab PCPC_Amazon_Practice_Labs_2019 Exercises |  | 
...
|Lab 13     | 14/05| Message-passing Programming Exercises Presentation|  | 
