...
|Lab 6      | 18/04| Amazon Web Service Lab PCPC_Amazon_Practice_Labs_2019 Exercises |  | 
|Lecture 7 | 30/04| Algoritmi per memoria condivisa + Progettazione di Algoritmi Paralleli| B2: C3.5.1-C3.5.4-C3.5.5 - [counting sort](https://spagnuolocarmine.github.io/news/counting-sort/) [slide1](https://spagnuolocarmine.github.io/assets/files/05_PCPC_Algorithms_for_shared_memory.pdf) [slide1](https://spagnuolocarmine.github.io/assets/files/06_Design_of_Parallel_Algorithm.pdf)|



<!--

|Lecture 8  | 02/05| Message-passing Programming Teoria 1 |  | 
|Lab 9      | 03/05| Message-passing Programming |  | 
|Lecture 10 | 07/05| Message-passing Programming Teoria 2 |  | 
